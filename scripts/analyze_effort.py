...
def main():
    ...
    if offline:
        ...
        rospy.Subscriber("/wash_left_jacobian", Jacobian, Analyzer.callback_left_jacobian)
        ...
        rospy.Subscriber("/wash_right_jacobian", Jacobian, Analyzer.callback_right_jacobian)
